...
class GameGraphics:
    ...
    def __init__(self, win_size: Tuple[int, int], surface: pygame.Surface) -> None:
    ...
    def draw_select(self, column: int, turn: int) -> None:
        ...
        if turn == 1:
            dark_colour = DARK_RED
            light_colour = RED
        else:
            dark_colour = DARK_YELLOW
            light_colour = YELLOW
        ...
        pygame.draw.circle(surf, dark_colour, pos, radius)
        ...
        pygame.draw.circle(surf, light_colour, pos, radius)
    ...
    def gameover_screen(self, winner: Optional[int], select: int) -> None:
        ...
        pygame.draw.polygon(
            surf,
            BLACK,
            ((100, 150), (100 + shift, 150 - shift), (700 + shift, 150 - shift), (700 + shift, 450 - shift), (700, 450), (700, 150)),
        )
        pygame.draw.polygon(
            surf,
            BLACK,
            ((200, 380), (200 + shift, 380 - shift), (320 + shift, 380 - shift), (320 + shift, 420 - shift), (320, 420), (320, 380)),
        )
        pygame.draw.polygon(
            surf,
            BLACK,
            ((480, 380), (480 + shift, 380 - shift), (600 + shift, 380 - shift), (600 + shift, 420 - shift), (600, 420), (600, 380)),
        )
